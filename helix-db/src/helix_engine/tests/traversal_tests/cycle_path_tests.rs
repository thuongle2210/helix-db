...
use crate::{helix_engine::{
        ...
        traversal_core::{
            ops::{g::G, source::{add_e::{AddEAdapter, EdgeType}, add_n::AddNAdapter}, util::cycle::{CyclePathAdapter}},
...
fn test_cycle_path_many_node() {
    ...
    let edge4 = G::new_mut(Arc::clone(&storage), &mut txn)
        .add_e(
            "knows",
            Some(props!("name" => "edge4")),
            node4.id(),
            node1.id(),
            false,
            EdgeType::Node,
